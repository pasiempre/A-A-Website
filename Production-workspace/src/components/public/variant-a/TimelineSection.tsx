    ...
    <div ref={ref} className={`group relative mb-5 flex flex-col ${reverse ? "md:flex-row-reverse" : "md:flex-row"} md:mb-14 md:items-center`}>
      ...
      >
        ...
        <div className={`mb-2 mt-2 inline-flex items-center gap-3 transition duration-700 md:mb-4 md:mt-0 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-4 opacity-0"}`}>
          <span className="icon-tile inline-flex h-8 w-8 text-[#0A1628] md:h-10 md:w-10">
            <StepIcon icon={step.icon} />
          </span>
          <p className="section-kicker text-[#2563EB]">{step.detail}</p>
        </div>
        ...
        {step.valueLine ? (
          <div className="mt-3 flex max-w-md items-start gap-2 rounded-lg bg-[#C9A94E]/8 px-3 py-2">
            <svg
              aria-hidden="true"
              viewBox="0 0 16 16"
            ...
            <span className="text-sm font-medium text-slate-700">{step.valueLine}</span>
          </div>
        ) : null}
        </div>
...
export function TimelineSection() {
  ...
  return (
    <section id="timeline" ref={ref} className="relative overflow-hidden border-b border-slate-200 bg-[#FAFAF8] py-12 md:py-28">
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className={`mb-8 text-center transition duration-700 md:mb-14 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}>
          ...
          <h2 className="mt-2 font-serif text-2xl tracking-tight text-[#0A1628] md:mt-0 md:text-5xl">How We Deliver</h2>
        </div>
